...
class MyServer(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if data.status_code == 200:
            ...
            self.wfile.write(bytes("<p>Befehl zum Starten wurde gesendet.</p>", "utf-8"))
            self.wfile.write(bytes("<p>Plex sollte in ca. 4Min verfuegbar sein.</p>", "utf-8"))
